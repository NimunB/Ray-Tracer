...
glass = gr.material({0, 0, 0}, {1, 1, 1}, 1000000, 3.0)
...
--refracted sphere
s4 = gr.nh_sphere('s4', {0, 0, 100}, 200)
s4:set_material(glass)
scene_root:add_child(s4)
s4:translate(0, 0, 100)
...
gr.render(scene_root, './pictures/refraction.png', 512, 512,
